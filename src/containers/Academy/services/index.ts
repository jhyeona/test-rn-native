...
import {InvitedAcademyListProps, ReqJoinAcademyProps, ResJoinAcademyProps} from '#types/user.ts';

export const requestGetInvitedAcademyList = async (): Promise<InvitedAcademyListProps> => {
  // 기관 초대 리스트
